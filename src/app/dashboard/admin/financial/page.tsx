...
const data = [
  { name: "House Chores", value: 185 },
  { name: "Care Services", value: 267 },
  { name: "Cooking Services", value: 333 },
  { name: "Snow Plowing", value: 215 }
];
        ...
        <Row gutter={[5,5]}>
          ...
          <Col lg={8} sm={24} xs={24} className="flex flex-col justify-end gap-1">
            <div className="flex flex-col justify-end gap-1 h-[250px]">
              <Dot color="#039855" title="Care Services" />
              <Dot color="#8A38F5" title="Snow Plowing" />
              <Dot color="#2860D8" title="Cooking Services" />
              <Dot color="#FED500" title="House Chores" />
            </div>
          </Col>
        </Row>
        </Card>
