...
const HireType = ({ open, onCancel, worker }: props) => {
  ...
  return (
    ...
    >
        <Row gutter={[15, 15]}>
            <Col lg={12} sm={12} xs={24} className='hover:bg-[#FFF5F7] hover:border hover:border-[#670316] transition-all bg-[#f4f4f4] cursor-pointer rounded-xl h-[145px] !flex flex-col items-center justify-center gap-4 text-[#151F32]' onClick={() => handleSelect(1)}>
            ...
            <Col lg={12} sm={12} xs={24} className='hover:bg-[#FFF5F7] hover:border hover:border-[#670316] transition-all bg-[#f4f4f4] cursor-pointer rounded-xl h-[145px] !flex flex-col items-center justify-center gap-4 text-[#151F32]' onClick={() => handleSelect(0)}>
