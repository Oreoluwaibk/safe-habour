  ...
  const handleGetMessages = useCallback(() => {
    ...
    .then(res => {
      if(res.status === 200) {
        ...
        if(applicationId) {
          const active = res.data.data.find((chat: IConversation) => chat.applicationId === applicationId);
        ...
        <Col lg={16} sm={12} xs={24}>
          ...
          >
            ...
            <div className='flex items-center justify-end'>
              <Button type="primary" onClick={handleSendMessage} loading={sendLoading} className='!w-[81px] !h-[40px] !rounded-[100px]'>Send</Button>
            </div>
