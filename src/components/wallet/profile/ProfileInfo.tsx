            ...
            title={
                <div className='flex items-center gap-2'>
                    ...
                    <div className='flex flex-col gap-1'>
                        <CardTitle title={authentication?.fullName || ""} status={<Status title={authentication?.isProfileComplete ? 'Verified' : "Unverified"} color={authentication?.isProfileComplete ? '#018A06': "#ff0004"} bg={authentication?.isProfileComplete ? '#f3fff4' : "#FFF7F9"} />} />
