...
import { BgChecked, Family, R1, R3, R4, R5, Rec1, Rec2, Rec3, Rec4, Service1, Service2, Service3, Service4, SideVec, Star1, Star2, Works1, Works2, Works3, Works4 } from '../../../../assets/image'
